...
halftone('orion.fits',head='rd',minmax=(0,20),palette='-gray')
contour('iras60.fits',head='rd',levels='border')       # draw the border
contour('iras60.fits',head='rd',levels=[40,60,80,100]) # contours
axis()
